...
public class QRGenerate {
    public static void main(String[] args) throws Exception {
        ...
        saveToFile(generateQRCodeImage("00020101021138540010A00000072701240006970407011099662288660208QRIBFTTA530370454062000005802VN62090805Hello6304E0B2"), "qr", "png");
    }
